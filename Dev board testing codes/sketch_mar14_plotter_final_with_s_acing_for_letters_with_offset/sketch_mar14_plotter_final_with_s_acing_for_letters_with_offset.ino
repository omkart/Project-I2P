    ...
    currentIndex++;
      ...
      switch ( atoi( buffer ) ){  
       ...
       Serial.println(maxValue);
        ...
        drawLine((1)+(newPos.x)+(maxValue)*(letterPositionValue), newPos.y ,newPos.z);
        //        Serial.println("ok");
        ...
        drawArc((1)+(newPos.x)+(maxValue)*(letterPositionValue), newPos.y,newPos.z,(1)+newPos.i+(maxValue)*(letterPositionValue),newPos.j,-1 );
               Serial.println("ok");
        actuatorPos.x = newPos.x;
        actuatorPos.y = newPos.y;
        break;
      ...
      case 1:{
       ...
       Serial.println(letterPositionValue);
        ...
        Serial.println((1)+(newPos.x)+((maxValue)*(letterPositionValue)));
        drawLine((1)+(newPos.x)+(maxValue)*(letterPositionValue), newPos.y ,newPos.z);
        //        Serial.println("ok");
        actuatorPos.x = newPos.x;
        actuatorPos.y = newPos.y;
