...
float StepsPerCentimeterX=50;   //needs to be changed
float StepsPerCentimeterY= 50;   //needs to be chamged
    ...
    Serial.println(buffer);
      switch ( atoi( buffer ) ){ 
        ...
        break;
            ...
            case 9:{
              Serial.println("Home co-ordinates executed");
              drawLine(0,0,-1);
              break;
            }
            case 2:{
               Serial.println("Arc clockwise executed");
           char* indexX = strchr( line+currentIndex, 'X' );  // Get X/Y position in the string (if any)
        char* indexY = strchr( line+currentIndex, 'Y' );
        ...
        break;
         ...
         // Select G command
          ...
          case 3:{
         Serial.println("Arc anti-clockwise executed");
           char* indexX = strchr( line+currentIndex, 'X' );  // Get X/Y position in the string (if any)
        char* indexY = strchr( line+currentIndex, 'Y' );
        char* indexI= strchr(line + currentIndex, 'I');
        char* indexJ=strchr(line +currentIndex , 'J');
